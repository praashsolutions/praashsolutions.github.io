						...
						for (
							...
							(n = t[s]),
								1 === n.nodeType &&
									...
									n.children.length > 1 &&
										(a.title = n.children[1].innerHTML),
									r.children.length > 0 &&
										(a.msrc = r.children[0].getAttribute(
											"src"
										)),
									(a.el = n),
									o.push(a));
						...
						if (
							...
							(a = {
								...
								getThumbBoundsFn: function(e) {
									var t = s[e].el.getElementsByTagName(
											"img"
										)[0],
										i =
											window.pageYOffset ||
